  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
   ...
   * 
   * - Name:  port_name
   * - DefaultValue: /dev/serial/by-id/usb-FTDI_TTL232R-3V3_FT98HKZC-if00-port0
   */
  ...
  /*!
   */
  JARA_ARM_LEFT_LeftManipulatorCommonInterface_MiddleSVC_impl m_LeftManipulatorCommonInterface_Middle;
  /*!
   */
  SeedWaist_SeedWaistInterfaceSVC_impl m_SeedWaistInterface;
  /*!
   */
  SeedNeck_SeedNeckInterfaceSVC_impl m_SeedNeckInterface;
